...
#define AMS_FS_MITM_INTERFACE_INFO(C, H)                                                                                                                                                                                                                                               \
    ...
    AMS_SF_METHOD_INFO(C, H, 400, Result, OpenDeviceOperator,              (sf::Out<sf::SharedPointer<ams::mitm::fs::IDeviceOperatorMitmInterface>> out),                                                               (out))                                                         \
...
namespace ams::mitm::fs {
    ...
    class FsMitmService  : public sf::MitmServiceImplBase {
        ...
        public:
            ...
            Result OpenDeviceOperator(sf::Out<sf::SharedPointer<IDeviceOperatorMitmInterface>> out);
